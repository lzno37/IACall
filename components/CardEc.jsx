...
import { Rocket, Settings, Code, CheckCircle } from "lucide-react";
  ...
  const phases = [
    {
      EN: {
        ...
        description:
          "We listen to your goals, confirm requirements, and align on clear success criteria for your business.",
        icon: CheckCircle,
        number: "01",
      },
      ES: {
        ...
        description:
          "Se recopilan las necesidades y se define el propósito del agente.",
        icon: CheckCircle,
        number: "01",
      },
    },
    {
      EN: {
        ...
        description:
          "We design and build your custom IACall agent, tailored to your industry, workflows, and brand voice.",
        icon: Settings,
        number: "02",
      },
      ES: {
        ...
        subtitle: "& desarrollo",
        description:
          "Se crea un agente personalizado adaptado a las necesidades de cada cliente y sector.",
        icon: Settings,
        number: "02",
      },
    },
    {
      EN: {
        ...
        description:
          "We deliver your agent for testing and connect everything securely with your systems.",
        icon: Code,
        number: "03",
      },
      ES: {
        ...
        description:
          "Se entrega el agente para probar y se conecta con los sistemas del cliente.",
        icon: Code,
        number: "03",
      },
    },
    {
      EN: {
        ...
        description:
          "We launch together, monitor performance, and continuously refine based on data and feedback.",
        icon: Rocket,
        number: "04",
      },
      ES: {
        ...
        description:
          "El agente se pone en marcha, se evalúa su desempeño y se ajusta continuamente.",
        icon: Rocket,
        number: "04",
      },
    },
