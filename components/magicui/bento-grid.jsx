...
const BentoGrid = ({ children, className, ...props }) => {
  return (
    <div
      className={cn(
        "grid w-full  grid-cols-4 max-lg:grid-cols-1 gap-4",
        className
      )}
      {...props}
    >
...
const BentoCard = ({
  ...
  >
    ...
    <div className="p-4 ">
      <div className="pointer-events-none bg-white  z-10 flex transform-gpu flex-col gap-1 transition-all duration-300 ">
        {/* <Icon
        ...
        <h3 className="text-2xl font-light text-neutral-700 ">{name}</h3>
